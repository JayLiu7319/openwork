  ...
  return (
    <section class="space-y-4">
      <div class="flex items-center justify-between">
        <h3 class="text-sm font-medium text-zinc-400 uppercase tracking-wider">{t('templates.title')}</h3>
      ...
      >
        <div class="space-y-6">
          <Show when={props.workspaceTemplates.length}>
            <div class="space-y-3">
              <div class="text-xs font-semibold text-zinc-500 uppercase tracking-wider">{t('templates.scope.workspace')}</div>
                  ...
                  <div class="bg-zinc-900/30 border border-zinc-800/50 rounded-2xl p-5 flex items-start justify-between gap-4">
                    <div class="min-w-0">
                      <div class="flex items-center gap-2">
                        ...
                        <div class="font-medium text-white truncate">{template.title}</div>
                      </div>
                      <div class="mt-1 text-sm text-zinc-500">{template.description || ""}</div>
                      <div class="mt-2 text-xs text-zinc-600 font-mono">{formatRelativeTime(template.createdAt, locale())}</div>
                    </div>
          ...
          <Show when={props.globalTemplates.length}>
            <div class="space-y-3">
              <div class="text-xs font-semibold text-zinc-500 uppercase tracking-wider">{t('templates.scope.global')}</div>
