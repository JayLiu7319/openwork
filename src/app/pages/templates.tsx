      ...
      >
        <div class="space-y-6">
          <Show when={props.workspaceTemplates.length}>
            <div class="space-y-3">
              <div class="text-xs font-semibold text-gray-10 uppercase tracking-wider">{t('templates.scope.workspace')}</div>
                ...
                {(template) => (
                  <div class="bg-gray-2/30 border border-gray-6/50 rounded-2xl p-5 flex items-start justify-between gap-4">
                    <div class="min-w-0">
                      ...
                      <div class="mt-2 text-xs text-gray-7 font-mono">{formatRelativeTime(template.createdAt, locale())}</div>
                    </div>
          ...
          <Show when={props.globalTemplates.length}>
            <div class="space-y-3">
              <div class="text-xs font-semibold text-gray-10 uppercase tracking-wider">{t('templates.scope.global')}</div>
