        ...
        <div class="relative w-full max-w-lg bg-gray-2 border border-gray-6 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div class="flex items-center justify-between px-6 py-4 border-b border-gray-6">
            <div>
              ...
              <p class="text-sm text-gray-11">{t('settings.mcp.authModal.connectSubtitle')}</p>
            </div>
            <button
              type="button"
            ...
            <Show when={!loading() && alreadyConnected()}>
              <div class="bg-green-7/10 border border-green-7/20 rounded-xl p-5 space-y-4">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <p class="text-sm font-medium text-gray-12">{t('settings.mcp.authModal.alreadyConnected')}</p>
            ...
            <Show when={!loading() && !error() && !alreadyConnected()}>
              <div class="space-y-4">
                <div class="flex items-start gap-3">
                  ...
                  <div>
                    <p class="text-sm font-medium text-gray-12">{t('settings.mcp.authModal.step1Title')}</p>
                ...
                <div class="flex items-start gap-3">
                  ...
                  <div>
                    <p class="text-sm font-medium text-gray-12">{t('settings.mcp.authModal.step2Title')}</p>
                    <p class="text-xs text-gray-10 mt-1">
                ...
                <div class="flex items-start gap-3">
                  ...
                  <div>
                    <p class="text-sm font-medium text-gray-12">{t('settings.mcp.authModal.step3Title')}</p>
                    <p class="text-xs text-gray-10 mt-1">
