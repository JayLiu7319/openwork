        ...
        <div class="bg-gray-2 border border-gray-6/70 w-full max-w-xl rounded-2xl shadow-2xl overflow-hidden">
          <div class="p-6">
            <div class="flex items-start justify-between gap-4">
              <div>
                <h3 class="text-lg font-semibold text-gray-12">{t('templates.modal.title')}</h3>
                <p class="text-sm text-gray-11 mt-1">{t('templates.modal.subtitle')}</p>
              </div>
            ...
            <div class="mt-6 space-y-4">
              ...
              <label class="block">
                <div class="mb-1 text-xs font-medium text-gray-11">{t('common.labels.prompt')}</div>
                <textarea
                ...
                />
                <div class="mt-1 text-xs text-gray-10">{t('templates.modal.hint')}</div>
              </label>
            </div>
